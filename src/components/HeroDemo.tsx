...
export function HeroDemo() {
  const [activeJob, setActiveJob] =
    useState<(typeof HERO_JOBS)[number]>(HERO_JOBS[0]);

  return (
    <>
      <div className="hero-copy">
        <p className="eyebrow">
          A fleet of agents with computers for every Amphenol seller
        </p>
        ...
        <p className="hero-intro">
          ...
          computers. These sample jobs cover public AI interconnect demand,
          high-speed and fiber-optic product work, Amphenol&apos;s decentralized
          operating model, and public context for the completed CommScope CCS
          acquisition and integration. Each sample stays a draft until a person
          reviews it.
        </p>
        <div
